...
test("feature flags expose all frontend module gates", () => {
  ...
  // 13 core module flags + 3 TradingView flags + 3 experience flags + 3 persistence flags = 22 total
  ...
  // Experience flags enabled
  assert.equal(flags.ENABLE_EXPERIENCE, true);
  assert.equal(flags.ENABLE_EXPERIENCE_PATTERNS, true);
  assert.equal(flags.ENABLE_EXPERIENCE_KNOWLEDGE, true);
